"""Freeze the identity-safe fixed-ETF residual-reversal successor."""
...
STRATEGY_ID = "liquid-etf-market-residual-reversal-replication-v2"
SUCCESSOR_ID = "liquid-etf-market-residual-reversal-replication-v2"
...
V1_CONTRACT = (
    ...
    "family-contract/"
    "contract-8bd5d5df84662d38e8c7f270ceebc39bd1ecfe6709275fd6a971f5b15c5439cc.json"
)
V1_FAILURE = (
    PROJECT_ROOT
    ...
    "liquid-etf-market-residual-reversal-replication-v1-"
    "development-collection-failure-"
    "6ec9232aae1cd63842a3551b06a7eabbbbfede403c9dfdb55b12476f7991bbe9.json"
)
V1_FAILURE_INSPECTION = (
    ...
    "liquid-etf-market-residual-reversal-replication-v1-"
    "development-collection-failure-inspection-"
    "7fd60bd8ec3d52b88d8c105e4f0edb892407dcea214bdb4a3a89f38669083105.json"
)


class EtfResidualReplication2Error(ValueError):
    """The structural successor or its adverse evidence graph drifted."""
...
def _timestamp(value: str, field: str) -> datetime:
    try:
        ...
        raise EtfResidualReplication2Error(
            f"{field} is invalid"
        ) from exc
...
def _validate_exposure_state(contract: Mapping[str, Any]) -> None:
    ...
    if not (
        ...
        raise EtfResidualReplication2Error(
            "v2 ETF residual scope has foreign outcome exposure"
        )
    ...
    contract.update(
        {
            ...
            "existing_successor_validator": {
                "module": "etf_residual_replication2",
            ...
            "universe_requirements": {
                ...
                "selection_basis": (
                    "Ten long-history liquid equity, factor, international, "
                    "and industry ETFs replacing every target identity whose "
                    "data was accessed by the structurally incomplete v1."
                ),
            },
            "universe": {
            ...
            "contamination_risks": [
                ...
                "All ten replacement target ETF/date pairs are globally untouched at freeze.",
                ...
                "All of 2020 remains embargo and 2021 replacement target outcomes are untouched.",
            ],
            "material_difference_rationale": (
                "This pre-metric structural successor replaces every v1 "
                "target identity after SPLG's frozen history proved "
                "incomplete. It changes no mechanism, parameter, date, cost, "
                "selection, execution, or evidence gate."
            ),
            "implementation_files": [
                "etf_residual_replication2.py",
...
def validate_existing_successor_contract(
    ...
    if not (
        ...
        raise EtfResidualReplication2Error(
            "identity-safe ETF residual contract drifted"
        )
    if enforce_commit:
        strategy_discovery.require_committed(Path(__file__).resolve())
    calendar = v1.partition_support._calendar_authority(
    ...
    if (
        ...
        raise EtfResidualReplication2Error(
            "identity-safe ETF residual calendar binding drifted"
        )
