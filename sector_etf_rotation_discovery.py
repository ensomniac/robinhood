"""Freeze a selection-aware liquid-sector-ETF rotation successor."""
...
SUCCESSOR_ID = "sector-etf-rotation-v2-liquid-daily"
...
SOURCE_ACTIVATION = (
    ...
    "5360bfd6c12065169975ec828a813f7e6f5042d87979131542b39659ca5df632.json"
)
SOURCE_INPUT_INSPECTION = (
    PROJECT_ROOT
    / "strategy_tournament/second_wave/inspections/"
    "sector-etf-rotation-v1-input-"
    "ae9133091afe877306589961ee1e6ad2383d698119a244b8e9e875add1805366.json"
)
PREDECESSOR_RESULT = (
    PROJECT_ROOT
    / "research_results/2026-07-21-sector-etf-rotation-stage0-"
    "29ea58ac2b950c25ee7f0d17246567daf3eac84a11cddcd9f0f873da08d1a646.json"
)
PREDECESSOR_INSPECTION = (
    PROJECT_ROOT
    / "strategy_tournament/second_wave/inspections/"
    "sector-etf-rotation-v1-result-"
    "563155de66061d57761fa18262893d435bb5d6d038bb9760791f92e127d43c20.json"
)


class SectorEtfRotationDiscoveryError(RuntimeError):
...
def _source_graph(
    *, enforce_commit: bool
    ...
    if not (
        ...
        raise SectorEtfRotationDiscoveryError(
            "bound sector-rotation source graph is invalid"
        )
...
def _outcome_blind_dates() -> list[str]:
    ...
    if (
        ...
        raise SectorEtfRotationDiscoveryError(
            "outcome-blind 2022 sector calendar capacity drifted"
        )
    return dates
...
def freeze_successor_contract(
    *,
    ...
    if not (
        ...
        raise SectorEtfRotationDiscoveryError(
            "sector evidence partition drifted"
        )
    ...
    external_relative = str(
        source.PRIVATE_INPUT_PATH.relative_to(
            source.DATA_ROOT
        )
    )
    ...
    contract: dict[str, Any] = {
        ...
        "predecessor": {
            ...
            "adverse_finding": (
                "The exact 2023-2025 v1 rule had only 1.016 primary "
                "profit factor, excessive drawdown, and negative 20-bps R."
            ),
        },
        "source_training": {
        ...
        "mechanism": (
            "Own the strongest completed-return U.S. sector ETF relative to "
            "SPY while SPY remains above a completed trend average."
        ),
        ...
        "entry_rule": (
            "At each completed session, require SPY above the frozen completed "
            "SMA, rank the eleven sector SPDRs by completed trailing return, "
            "and enter the strongest qualified sector at the next open."
        ),
        "stop_rule": (
        ...
        "exit_rule": (
            ...
            "the completed close after one or three sessions."
        ),
        "ranking_rule": (
            "Rank by highest completed trailing return, tie-break lexically, "
            "and admit no more than one new family entry per session."
        ),
        "selection_rule": (
            "Require the frozen excess return over SPY and the five-times-cost "
            "floor; portfolio risk, contention, entry, and notional caps remain "
            "authoritative."
        ),
        "parameter_grid": {
            "return_lookback_sessions": [5, 20],
            "minimum_excess_return_fraction": [0.0, 0.01],
            "market_trend_sma": [20, 60],
            "stop_atr14": [1.0, 1.5],
            "maximum_hold_sessions": [1, 3],
        },
        ...
        "execution_assumptions": {
            ...
            "expected_gross_proxy": (
                "completed sector trailing return minus completed SPY return"
            ),
        },
        ...
        "production_compatibility_risks": [
            "Current complete sector history, quotes, spreads, depth, halts, tradability, timestamps, protection, and reconciliation remain mandatory."
        ],
        "material_difference_rationale": (
            "This successor preserves sector leadership while prospectively "
            "testing frozen lookbacks, relative-strength floors, trend gates, "
            "stops, and shorter holds on dates disjoint from v1."
        ),
        ...
        "implementation_files": [
            "sector_etf_rotation_discovery.py",
            "sector_etf_rotation_plugin.py",
        ...
        "plugin": {
            "module": "sector_etf_rotation_plugin",
            "preflight": "preflight",
...
def main() -> int:
    ...
    try:
        ...
        OSError,
        SectorEtfRotationDiscoveryError,
