"""Independent entrypoint for Schedule 13D Stage 0 inspections."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        if args.command == "contract":
            ...
            value = stage0.inspect_result(args.activation, args.inspection, args.result)
    except (stage0.Schedule13dStage0Error, OSError, ValueError) as exc:
