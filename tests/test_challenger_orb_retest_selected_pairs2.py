...
import challenger_orb_retest_selected_pairs2 as freezer
import challenger_orb_retest_selected_pairs2_inspection as inspector
...
def test_inspector_scopes_second_tranche_and_restores_base(monkeypatch):
