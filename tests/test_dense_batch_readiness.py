...
def test_preactivation_readiness_resolves_exact_committed_boundary():
    ...
    assert status["state"] == "PREACTIVATION_READY"
...
def test_readiness_opens_only_calendar_provider_step_after_reset():
    status = readiness.build_status(
