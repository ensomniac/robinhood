"""Inspect the third ORB-retest tranche's frozen source contract."""
...
def _verify_publication(
    ...
    *,
    ...
    if not isinstance(publication, Mapping):
        raise contract.ChallengerCatalystContract3Error(
...
def inspect_contract(
    *,
    ...
    if manifest.get("dataset_id") != dataset_id:
        raise contract.ChallengerCatalystContract3Error(
            "unexpected third-tranche source contract"
        )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        contract.ChallengerCatalystContract3Error,
